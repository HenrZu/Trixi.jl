...
# Uncomment the amount of firstorder and Max Data saves in "positivity_alpha_rueda_gassner.jl"
using DelimitedFiles
A = limiter!.labels
t= A[1:3:end]
firstorder = A[2:3:end]
max= A[3:3:end]

open("T15_khi_1d_nn.txt", "w") do io
	writedlm(io, [t firstorder])
end
