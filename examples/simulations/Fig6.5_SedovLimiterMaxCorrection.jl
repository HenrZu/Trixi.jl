...
# For limiter case : 
# !!!!!! activate Limiter in indicator_2d !!!!!!!!!!
...
###############################################################################
# run the simulation
# Leave limiter in here. Needed to save the results. Deactivate the Limiter itself in "positivity_alpha_rueda_gassner.jl"
...
# Uncomment the Mean Data and Max Data saves
